  ...
  callback: async (client, interaction) => {
    ...
    const row = new ActionRowBuilder()
        ...
        const embed = new EmbedBuilder()
            ...
            .setAuthor({ name: 'CarlR.#9122', iconURL: client.user.avatarURL() })
            .setTimestamp();
    ...
    console.log(`[${getTimestamp()}][CREDITS]: ${interaction.user.tag} used the command /credits in ${interaction.guild.name}.`);
    } catch (error) {
      console.log(error);
    }
  },
